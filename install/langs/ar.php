...
// KLEEJA 
	...
	$lang['INST_NO_WRTABLE']					= 'مجلد غير قابل للكتابه .. ';
	$lang['INST_GOOD_GO']						= 'تم التأكد من المتغييرات والإتصال والتراخيص .. تابع';
	$lang['INST_MSGINS']						= 'أهلا بك في مركز التحميل . يمكنك تحميل ماتشاء وفق المسموح به ..شكراُ لزيارتك';
	...
	$lang['DB_INFO']							=	'قم بإدخال معلومات قاعدة البيانات بشكل صحيح .. ثم سوف نصدرها لك كملف , تضعه في مجلد السكربت الرئيسي';
	...
	$lang['INST_NOTE_RC4_TO_RC5']				=	'لا بد ان تقوم أيضا بإستبدال الملفات الجديده المعدله لإستكمال الترقيه بشكل جيد !, وقم بتثبيت الستايل الموجود في /install/res/style.xml من لوحة التحكم';
	$lang['INST_UPDATE_IS_FINISH']				=	"معالج التحديث انتهى .. يمكنك الآن حذف مجلد <br/><b>INSTALL</b><br/> و متابعة عملك في كليجا ..";
