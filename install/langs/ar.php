...
// KLEEJA 
	...
	$lang['DB_INFO']							=	'قم بإدخال معلومات قاعدة البيانات بشكل صحيح .. ثم سوف نصدرها لك كملف , تصعه في مجلد المنتدى الرئيسي';
	...
	$lang['INST_NOTE_RC2_TO_RC3']				=	'لا بد ان تقوم أيضا بتحديث ملفات النسخه ككل وليس فقط تشغيل هذا المعالج ...';
