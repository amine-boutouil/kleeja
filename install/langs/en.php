...
// Email: n.k@cityofangelz.com 
	...
	$lang['INST_INSTALL_CLEAN_VER']	=	"ÊËÈíÊ äÓÎå ÌÏíÏå";
	$lang['INST_UPDATE_P_VER']	=	"ÊÍÏíË äÓÎå ÓÇÈÞå ";
	$lang['INST_CHOOSE_INSTALLER']	=	"... Þã ÈÅÎÊíÇÑ ãÇ íäÇÓÈß  ãä ãÚÇáÌ ÊËÈíÊ ßáíÌÇ ...";
	...
	$lang['INDEX'] = 'ÇáÑÆíÓíå';
	$lang['ADMINCP'] = 'áæÍÉ ÇáÊÍßã';
	
	//UPDATOR
	$lang['INST_CHOOSE_UPDATE_FILE']	=	'Þã ÈÅÎÊíÇÑ ÇáÊÍÏíË ÇáãäÇÓÈ áß æãä Ëã ÊÇÈÚ ÇáÊÍÏíË ..';
	$lang['INST_ERR_NO_SELECTED_UPFILE_GOOD']	=	'ãáÝ ÇáÊÍÏíË ÛíÑ ãäÇÓÈ Çæ Çäå ÛíÑ ãæÌæÏ ãä ÇáÃÓÇÓ ! ..';
	
	$lang['INST_NOTES_UPDATE']		=	'ãáÇÍÙÇÊ ÇáÊÍÏíË';
	$lang['INST_NOTE_RC2_TO_RC3']	=	'áÇ ÈÏ Çä ÊÞæã ÃíÖÇ ÈÊÍÏíË ãáÝÇÊ ÇáäÓÎå ßßá æáíÓ ÝÞØ ÊÔÛíá åÐÇ ÇáãÚÇáÌ ...';
	$lang['INST_UPDATE_IS_FINISH']	=	"ãÚÇáÌ ÇáÊÍÏíË ÇäÊåì .. íãßäß ÇáÂä ÍÐÝ ãÌáÏ <br/><b>INSTALL</b><br/> æ ãÊÇÈÚÉ Úãáß Ýí ßáíÌÇ ..";
