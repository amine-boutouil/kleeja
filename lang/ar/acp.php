...
$lang = array_merge($lang, array(
	...
	'FIRST_TIME_CP'				=> 'أول مره في لوحة التحكم؟!',
	'FIRST_TIME_CP_EX'			=> 'منذ 2007 و فريق تطوير كليجا يقوم بدراسة طريقة المستخدمين في كيفية استخدامهم للوحة التحكم وبعد عدة نسخ تطويرية' . 
									' اكتشفنا اننا نستطيع تقديم افكار جديدة تعطي المستخدم القدرة بالتحكم بوقت اقل و بنفس الكفائه السابقة' .
									'و قمنا بانشاء عدة افكار ستلاحظها اثناء تجوالك لاحقاً باللوحة ومن اهمها الاجاكس و القوائم الجديدة.' . 
									'<br /><br /> وهنا بالاسفل شرح للوحة وكيفية استخدامها /',
	'FIRST_TIME_HOW1'			=> 'قائمة لوحة تحكم كليجا الاساسية, من هنا تنتقل لادارة الصور او الملفات وهكذا.',
	'FIRST_TIME_HOW2'			=> 'زر البداية, ينقلك لبداية لوحة تحكم كليجا.',
	'FIRST_TIME_HOW3'			=> 'زر بداية الموقع, ينقلك لصفحة بداية المركز.',
	'FIRST_TIME_HOW4'			=> 'زر تسجيل الخروج من اللوحة, حيث ان جلستك الادارية تمسح وتصبح عضو عادي.',
	'FIRST_TIME_HOW5'			=> 'زر الاعدادات, من هنا تستطيع ادارة كليجا وتعديلها كما تريد.',
	'FIRST_TIME_HOW6'			=> 'هذه هي القائمة الفرعية من كل قسم, فمثلا هنا سترى قائمة خاصة بادارة الصور وغيره.',
	'FIRST_TIME_HOW7'			=> 'هنا تظهر محتويات كل رابط تضغطه بحيث يكون مريح للعين و بسيط للادارة.',
	'FIRST_TIME_DONE'			=> 'فهمت, شكراً',
