...
// KLEEJA 
	...
	$lang['PLUGINS_BUILT_IN']					= 'هذه اضافات تأتي مع كليجا بشكل افتراضي , اذا اردت ازالة تضمين احدها فكل ماعليك هو ازالة التعليم عليها , ولكن ننصحك بعدم فعل ذلك لان هذه الاضافات تم التحقق منها وهي مفيده لعمل كليجا بشكل جيد ... ';
	$lang['PLUGINS_NAME']						= 'اسم الاضافة';
	$lang['PLUGINS_VER']						= 'اصدار الاضافة';
