...
// KLEEJA 
	...
	$lang['INST_UPDATE_IS_FINISH']				= "معالج التحديث انتهى .. يجب الآن حذف مجلد <br /><b>INSTALL</b><br /> و متابعة عملك في كليجا ..";
		$lang['IN_INFO']						= 'ادخل معلومات المنتدى بشكل صحيح ليتم ربطه مع كليجا او تجاهل هذه الخطوه اذا كنت لاترغب بدمج المنتدى مع كليجا<br /><span style="color:red;">ملاحظة : بعد الانتهاء من ثبيت كليجا قم باختيار نظام الاعضاء من لوحة التحكم في كليجا</span>';
	$lang['IN_PATH']							= 'مجلد المنتدى';
	$lang['IN_CHARSET']							= 'نوع ترميز المنتدى';
