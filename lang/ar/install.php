...
// KLEEJA 
	...
	$lang['DB_INFO_NW']							= 'أدخل بيانات القاعدة بشكل صحيح .. ثم اضغط على التالي وسيقوم المعالج بتصدير ملف config.php لتضعه في مجلد السكربت الرئيسي !';
	...
	$lang['INST_NOTE_RC2_TO_RC3']				= 'لا بد ان تقوم بإستبدال الملفات الجديده المعدله لإستكمال الترقيه بشكل جيد .!!';
	$lang['INST_NOTE_RC4_TO_RC5']				= 'لا بد ان تقوم بإستبدال الملفات الجديده المعدله لإستكمال الترقيه بشكل جيد .!!';
	$lang['INST_NOTE_RC5_TO_RC6']				= 'لا بد ان تقوم بإستبدال الملفات الجديده المعدله لإستكمال الترقيه بشكل جيد .!!';
	$lang['INST_NOTE_RC6_TO_1.0.0']				= 'لا بد ان تقوم بإستبدال الملفات الجديده المعدله لإستكمال الترقيه بشكل جيد .!!';
