...
if (empty($lang) || !is_array($lang))
	...
	'PFILE_4_FORUM' => 'بڕۆ بۆ یانه‌ یاخود مه‌کۆ بۆ گۆڕینی زانیاریه‌کانت', // change forum to users cp
	...
	'ALLOW_G' => 'ڕێدان [م]',
	'ALLOW_U' => 'ڕێدان [ئ]',
	'E_EXTS' => '<b>م</b>: واته‌ میوان <br/> <b>ئ</b>: واته‌ ئه‌ندام  <br/>قه‌باره‌کان به‌ بایت دیاریکراوه‌.', // change bytes to kb
