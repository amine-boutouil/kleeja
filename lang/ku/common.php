...
if (empty($lang) || !is_array($lang))
	...
	'ALLOW_G' => 'ڕێدان [م]',
	'ALLOW_U' => 'ڕێدان [ئ]',
	'E_EXTS' => '<b>م</b>: واته‌ میوان <br/> <b>ئ</b>: واته‌ ئه‌ندام  <br/>قه‌باره‌کان به‌ كيلۆبايت دیاریکراوه‌.', // change bytes to kb
	...
	'R_REPORTS' => 'به‌ڕێوه‌بردنی ڕاپۆرتدانه‌کان',
	...
	//rc6
	'U_USE_PRE_RE' => 'تۆوه‌شانی کاتی به‌کارده‌به‌یت , کرته‌ <a href="http://www.kurdhome.net/forum/forumdisplay.php?f=27/">لێره‌ بکه‌</a> بۆ ئاگادارکردنه‌وه‌مان له‌هه‌ر هه‌ڵه‌یه‌ک که‌ به‌دی ده‌که‌یت.',
	...
	'STYLE_DIR_NOT_WR'	=>	'بوخچه‌ی ڕوخسار ی%s ڕێگه‌ی تێدا نوسین نادات , واتا ناتوانیت گۆڕانکاری له‌ قاڵبه‌کانیدا بکه‌یت تا ئه‌و کاته‌ی ڕێدانی بوخچه‌که‌ ده‌که‌یته‌ 777.',
