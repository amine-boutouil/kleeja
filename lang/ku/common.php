...
$lang = array_merge($lang, array(
	...
	'GUIDE_EXP' => 'درێژکراوه‌ی ڕێپێدراو به‌ئه‌ندامان و قه‌باره‌کانیان:',
	'EXT' => 'درێژکراوه‌',
	'SIZE' => 'قه‌باره‌',
	'REPORT' => 'ڕاپۆرتدان',
	'YOURNAME' => 'ناو',
	...
	'PREFIXNAME' => 'سه‌ره‌تای ناوی په‌ڕگه‌کان <small>(نمونه‌ : webchin_ له‌دوای ناوی هه‌موو په‌ڕگه‌یه‌کی بارکراوه‌وه‌ ده‌رده‌که‌وێت)</small>',
	...
	'LAST_BING' => 'دوا سه‌ردانی Bing',
	'BING_NUM' => 'سه‌ردانه‌کانی Bing',
	...
	//rc6
	'U_USE_PRE_RE' => 'تۆ وه‌شانی کاتی به‌کارده‌به‌یت , کرته‌ <a href="http://http://www.webchin.org/Meko/viewforum.php?id=35/">لێره‌ بکه‌</a> بۆ ئاگادارکردنه‌وه‌مان له‌هه‌ر هه‌ڵه‌یه‌ک که‌به‌دی ده‌که‌یت.',
	...
	'PASS_ON_CHANGE'			=> 'گۆڕینی وشه‌ی نهێنی',
	...
	'PLUGIN_FTP_EXP'			=> 'ناتوانین دەستکاری پەڕگەکان بکەین بە بێ بوونی زانیاریەکانی FTP، بۆیە لەخوارەوە بینوسە تا زیادکاری جێگیربکرێت',
	'PLUGIN_FTP_HOST'			=> 'ڕاژەیFTP',
	'PLUGIN_FTP_USER'			=> 'ناوی بەکارهێنەریFTP',
	'PLUGIN_FTP_PASS'			=> 'وشەی تێپەڕبوونیFTP',
	'PLUGIN_FTP_PATH'			=> 'ڕێچکەی سکریپت لە FTP',
	'PLUGIN_FTP_PORT'			=> 'دەرگایFTP <small>(زۆربەی کات 21 بۆیە گەر دڵنیانیت وازی لێبێنە وەک خۆی.)</small>',
	'PLUGIN_CONFIRM_ADD'		=> 'ئاگاداربە، زیادکاری گۆڕانکاری بەرنامەیە لەسەر سکریپت و هەندێک جار خەتەرناکە، بۆیە گەر دڵنیا نیت لەسەرچاوەکەی یاخود لە ماڵپەڕی کلیجاوە داتنەگرتووە باشترە وازی لێبێنیت. دڵنیایت لە دامەزراندن ؟',
	...
	'PLUGIN_DELETED_ZIPPED'		=> 'زیادکاری سڕایەوە، بۆ تەواو کردنی سڕینەوە هەستە بە%1$sداگرتنی%2$s پەڕگە چاکراوەکان و گۆڕینیان', 
	'PLUGINS_CHANGES_FILES'		=> 'پەڕگە چاککراوەکان لە دامەزرادنی زیادکاریەکان', 
	'PLUGINS_CHANGES_FILES_EXP'	=> 'ئەم پەڕگە پەستێنراوانە پەڕەی دەستکاریکراوی هەندێک زیادکارین، دەبێت لێرەوە دایانگریت و هەستیت بەگۆڕینیان لەسەر ڕاژە، دەتوانیت بیان سریتەوە پاش کۆتایهاتنی کردارەکە.',
	'LOAD_IS_HIGH_NOW'			=> 'ماڵپەڕەکەمان پەستانێکی زۆری لەسەرە لەم کاتەدا !، تکایە چاوەڕوانبە و دواتر ئەم لاپەڕەیە نوێبکەرەوە.',

	//last line of this file ...					 
	'S_TRANSLATED_BY' 			=> 'Translated By <a href="http://www.webchin.org/" target="_blank">Webchin</a>',
	));
