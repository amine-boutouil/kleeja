<!-- $Id: up_boxes.html 2157 2013-08-18 04:33:20Z saanina $ -->
...
<div class="clr"></div>
	...
	<table border="0" width="100%" cellspacing="0" cellpadding="0" class="up_box_input">
		<tr>
			...
			<td class="all_box_link"><textarea rows="2" cols="40" class="up_input" tabindex="1" onclick="this.select();">[url={b_url_link}][img]{b_img_link}[/img][/url]</textarea></td>
		</tr>
	</table>
