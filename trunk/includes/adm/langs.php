<?php
	...
	if (isset($_POST['submit']))
	{
			$text	= ($SQL->affected() ? $lang['WORDS_UPDATED'] : $lang['NO_UP_CHANGE_S']) . '<meta HTTP-EQUIV="REFRESH" content="0; url=' . basename(ADMIN_PATH) . '?cp=langs&amp;page=' . (isset($_GET['page']) ? intval($_GET['page']) : '1') . '&amp;lang=' . $SQL->escape($_REQUEST['lang']) . '">' . "\n";
			$stylee	= "admin_info";
	}
