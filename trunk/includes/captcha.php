...
function kleeja_cpatcha_image()
{
	...
	if(function_exists('imagettftext'))
	{
		...
		//
		imagettftext ($image, 16,$angle , rand(50, $x), $y+rand(1,3), $white, dirname(__FILE__) . '/includes/arial.ttf', $security_code);
		#imagettftext ($image, 7, 0, $width-30, $height-4, $white,'./arial.ttf', 'Kleeja');
	}
	else
	{
		imagestring ($image, imageloadfont(dirname(__FILE__) . '/includes/arial.gdf'), $x+rand(10,15), $y-rand(10,15), $security_code, $white);
