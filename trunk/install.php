...
case 'data' : 
	...
	if ( isset($_POST['datasubmit']) ) {
		...
		$pass = md5($_POST['password']);
		 ...
		 $sql[30] =  @mysql_query($sql_exts, $connect);		 
		 $sql[31] =  @mysql_query($sql_exts2, $connect);	
		 $sql[32] =  @mysql_query($sql_exts3, $connect);	
		 $sql[33] =  @mysql_query($sql_exts4, $connect);	
		 $sql[34] =  @mysql_query($sql_exts5, $connect);	
		 $sql[35] =  @mysql_query($sql_exts6, $connect);	
		 $sql[36] =  @mysql_query($sql_exts7, $connect);	
