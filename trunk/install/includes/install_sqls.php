...
$install_sqls['TeamMsg_insert'] = "INSERT INTO `{$dbprefix}call` (`name`,`text`,`mail`,`time`,`ip`) VALUES ('" . $lang['KLEEJA_TEAM_MSG_NAME'] . "', '" . $lang['KLEEJA_TEAM_MSG_TEXT'] . "','saanina@gmail.com', " . time() . ", '127.0.0.1')";
