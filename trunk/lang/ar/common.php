...
$lang = array_merge($lang, array(
	...
	'LIVEXTS'				=> 'امتدادات بروابط مباشرة <p class="live_xts">افصل بين الامتدادات باستخدام الفاصلة (<font style="font-size:large"> , </font>)</p>',
	'MUST_LOGIN'			=> 'مرحباً بك في صفحة تسجيل الدخول للوحة تحكم [كليجا] ,, لكي تستطيع تسجيل الدخول  .. يجب أن تدخل إسم مستخدم وكلمة مرور صحيحه ..!',
