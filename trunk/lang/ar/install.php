...
// KLEEJA 
	...
	$lang['INST_FINISH_SQL']					= 'تم الانتهاء من تثبيت كليجا .. <br /> فضلاً قم بحذف  مجلد التثبيت  install لأنه لن يعمل الموقع في حالة وجود مجلد الانستول , شكراً لإستخدامك كليجا .. لأي ملاحظات أو مشاكل متعلقة بالسكربت نرجوا التوجه نحو موقع كليجا والكتابة الى مطوري كليجا ,,';
	...
	$lang['IS_IT_OFFICIAL_NO']					= '<a style="color:red" target="_blank" href="http://www.kleeja.com">لا , لم اقم بتحميلها من هناك , حولني للموقع  الرسمي للتحميل الان</a>';
	$lang['INST_WHAT_IS_KLEEJA_T']				= 'ماهي كليجا ؟';
	$lang['INST_WHAT_IS_KLEEJA']				= 'Kleeja  تنطق عربياً " كليجا " ..! <br /> سكربت رفع ملفات مجاني و مفتوح المصدر مع خصائص فريده لمساعدة أصحاب المواقع بأن يمتلكو مركز تحميل قوي ويعتمد عليه  .. هذا كتعريف مبسط  , أما كليجا في الحقيقه هو سكربت ضخم الامكانيات سهل الإدارة والأهم هو أن نظام الحماية متين  ويملك من الأنظمة المعقدة ما يؤمن لموقعك الحماية التامة بإذن الله ..!';
	$lang['INST_SPECIAL_KLEEJA']				= 'من أهم مميزات كليجا ..!';
	$lang['INST_WHAT_IS_KLEEJA_ONE']			= '1. نظام أعضاء قوي تستطيع ربطه بأغلب السكربتات المستخدمة في المواقع الاجتماعية .<br />2. لوحة تحكم مذهله ليس فقط للتحكم بالملفات ولكن للتحكم أيضا بكل صغيره وكبيره بالسكربت .<br />3. نظام الستايلات البسيط يجعلك تستطيع ان تصنع ستايلك بنفسك.<br />4. مع كليجا ونظام الإضافات البرمجية تستطيع أن تقوم بتركيب الكثير من الاضافات الرائعة .<br />5. ليس هذا فحسب بل كليجا تملك الكثير والكثير .. رجاءاً قم بزيارة الصفحه <a target="_blank" href="http://www.kleeja.com/about/">معلومات ومميزات</a> لتعرف أكثر .';
	$lang['YES']								= 'نعم';
	$lang['NO']									= 'لا';
	...
	$lang['PLUGINS_BUILT_IN']					= 'هذه اضافات تأتي مع كليجا بشكل افتراضي , اذا اردت ازالة تضمين احدها فكل ماعليك هو ازالة التعليم عليها , ولكن ننصحك بعدم فعل ذلك لان هذه الاضافات تم التحقق منها وهي مفيده لعمل كليجا بشكل جيد  ,, وللحصول على المزيد من الهاكات قم بزيارة موقع <a style="color:red" target="_blank" href="http://www.kleeja.com/plugins/">kleeja.com !</a>';
