...
// KLEEJA 
	...
	$lang['INST_FINISH_SQL']					= 'تم الانتهاء من تثبيت كليجا .. <br /> فضلاً قم بحذف  مجلد التثبيت  install  لن يعمل الموقع في حالة وجود مجلد الانستول .. <br /> شكراً لإستخدامك كليجا .. لأي ملاحظات أو مشاكل متعلقة بالسكربت نرجوا التوجه نحو موقع كليجا والكتابة الى مطوري كليجا ,,';
