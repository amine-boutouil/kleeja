...
// KLEEJA 
	...
	$lang['INST_FINISH_SQL']					= 'تم الانتهاء من تثبيت كليجا .. <br /><span class="sure"> فضلاً قم بحذف  مجلد التثبيت لن يعمل الموقع في حالة وجود مجلد الانستول ..</span><br /> لأي ملاحظات أو مشاكل متعلقة بالسكربت نرجوا التوجه نحو موقع كليجا والكتابة الى مطوري كليجا ,,';
