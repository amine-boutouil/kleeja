...
$lang = array_merge($lang, array(
	...
	'LANGUAGE' => 'زمان',
	'DECODE' => 'گۆڕینی ناوی په‌ڕگه‌ <small>(تێبینی : له‌کاتی خستنه‌ڕووی په‌ڕگه‌دا نوه‌ سه‌ره‌کیه‌که‌ی ده‌رده‌که‌وێت, ئه‌مه‌ بۆ پاراستن و ڕێکخستنه‌)</small>',
	...
	'E_EXTS' => 'ملاحظة  : قه‌باره‌کان به‌ کیلۆبایت پێوانه‌ کراون .',
	...
	'SITE_FOR_MEMBER_ONLY'		=> 'ناوه‌ند ته‌نها بۆ ئه‌ندامانه‌ ، بچۆ ژووره‌وه‌ یان خۆت تۆماربکه‌ تا بتوانیت باربکه‌یت.',
	...
	'REFRESH_CAPTCHA'			=> 'کرته‌ بکه‌ بهۆ گۆڕینی وێنه‌ به‌ دانه‌یه‌کی تر',
	...
	'KLEEJA_TEAM'				=> 'تیمی پێشخستنی کلیجا .. !',
	'ERR_SEND_MAIL'				=> 'هه‌ڵه‌یه‌ک له‌ ناردن دا , هه‌وڵیکی تربده‌ .. !',
	...
	'COMMA_X'					=> '<p class="live_xts">درێژکراوه‌کان به‌بۆشای جیا بکه‌ره‌وه‌ (<font style="font-size:large"> , </font>)</p>', 
	'NO_SEARCH_WORD'			=> 'هیچ ووشه‌یه‌کت نه‌نوسیووه‌ بۆ گه‌ڕان !',
	'GUESTSECTOUPLOAD'			=> 'چرکه‌ چاوه‌ڕوانکردن له‌نێوان هه‌ر کردارێکی بارکردن له‌لایه‌ن میوانه‌وه‌',
	'USERSECTOUPLOAD'			=> 'چرکه‌ چاوه‌ڕوانکردن له‌نێوان هه‌ر کردارێکی بارکردن له‌لایه‌ن ئه‌ندامه‌وه‌',
